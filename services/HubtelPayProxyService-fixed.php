<?php
/**
 * Hubtel PayProxy Service - Fixed Version
 * Uses the correct payproxyapi.hubtel.com/items/initiate endpoint with proper response parsing
 */
    ...
    public function createCheckout($params) {
        try {
            ...
            $data = [
                ...
                'callbackUrl' => $params['callbackUrl'] ?? 'https://gs-callback.hubtel.com/callback',
                'returnUrl' => $params['returnUrl'] ?? $params['callbackUrl'] ?? 'https://gs-callback.hubtel.com/callback',
                'merchantAccountNumber' => $this->merchantAccount,
                'cancellationUrl' => $params['cancellationUrl'] ?? $params['returnUrl'] ?? 'https://gs-callback.hubtel.com/callback',
